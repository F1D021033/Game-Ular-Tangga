...
import javax.swing.*;
import src.Controller.UlarTanggaThread;
import src.Database.DatabaseHandler;
// Kelas UlarTangga yang mengimplementasikan ActionListener dan GameInterface
public class UlarTangga extends JFrame implements ActionListener, GameInterface {
   ...
   public static ImageIcon[] dadu = new ImageIcon[]{new ImageIcon("img/dice1.png"), new ImageIcon("img/dadu2.jpeg"), new ImageIcon("img/dice3.png"), new ImageIcon("img/dadu4.jpeg"), new ImageIcon("img/dice5.png"), new ImageIcon("img/dadu6.jpeg")};
   // Array ikon papan permainan untuk berbagai kondisi
   ...
   public void callImage(){
      // Mengisi array ikon papan permainan dari berbagai kondisi
      for(int i = 0; i < 10; ++i) {
         for(int j = 0; j < 10; ++j) {
   ...
   public void jalan(int posisiP1, int posisiP2, int giliran) {
      // Memanggil metode Jalan dari GameManager untuk mengatur pergerakan pemain
   ...
   // Implementasi metode actionPerformed dari ActionListener
   public void actionPerformed(ActionEvent e) {
      if (e.getSource() == this.menuNew) {
         ...
         JOptionPane.showMessageDialog((Component)null, "Cara bermain:\n1. Klik Menu File\n2. Kemudian pilih 2 Player\n3. Lalu isi Nama dan kocok dadu");
